...
<?php if(!empty($msg)){echo $msg; }?>
    ...
    <form method="post" action="">
          ...
          <input type="password" placeholder="Enter Password" name="password" required value="<?php echo isset($editData) ? $editData['password'] : '' ?>">
          ...
          <input type="text" placeholder="Enter Assign Vehicles" name="assign_vechicles" required value="<?php echo isset($editData) ? $editData['assign_vechicles'] : '' ?>">
